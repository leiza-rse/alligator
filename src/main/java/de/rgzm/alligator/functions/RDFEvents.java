...
public class RDFEvents {
    ...
    public static void writeRDF(String filename, Alligator alligator) {
        ...
        // prefixes
        rdfString.append("@prefix alligator: <https://rgzm.github.io/alligator/vocab#> .\r\n");
        ...
        for (Object event : alligator.events) {
            ...
            if (ae.nn_start_id != null) {
                ...
                rdfString.append(aeSubject).append(" alligator:nfsnE ae:").append(ae.nn_start_id).append(" .\r\n");
            }
            if (ae.nn_end_id != null) {
                rdfString.append(aeSubject).append(" alligator:nfen \"").append(ae.nn_end_name).append("\" .\r\n");
                rdfString.append(aeSubject).append(" alligator:nfenE ae:").append(ae.nn_end_id).append(" .\r\n");
            }
            rdfString.append("\r\n");
        }
        // allen relations
